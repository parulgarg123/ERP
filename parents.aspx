<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="parents.aspx.cs" Inherits="Default3" %>
                        ...
                        <div id="login" class="form-group">
                            <form  action="mysuperscript.php" autocomplete="on"> 
                                ...
                                <p class="login button"> 
                                    ...
                                    <asp:Button ID="submit" runat="server" Text="Login" OnClick="submit_Click"></asp:Button>
								</p>
                                <asp:Label ID="Label1" runat="server" Text="Label">INVALID USERNAME OR PASSWORD</asp:Label>
                            </form>
                        </div>
