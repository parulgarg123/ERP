...
public partial class next_cc_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        department.Items.Add(new ListItem(Convert.ToString(Session["dept_cc"]), Convert.ToString(Session["dept_cc"])));
    }
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        objprp.lastupd = Convert.ToString(Session["cod"]) + "||" + "Cc" + "||" + Convert.ToString(DateTime.Now);
        try
        {
