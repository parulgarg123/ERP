<%@ Page Title="" Language="C#" MasterPageFile="~/next/hod/hod.master" AutoEventWireup="true" CodeFile="add_student.aspx.cs" Inherits="next_hod_Default" %>
        ...
        <div class="row">
            <form role="form">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        <label for="InputName">Parent email</label>
                        <div class="input-group">
