<%@ Page Title="" Language="C#" MasterPageFile="~/next/hod/hod.master" AutoEventWireup="true" CodeFile="cc_update.aspx.cs" Inherits="next_hod_Default" %>
        ...
        <div class="row">
            <form role="form">
                <div class="col-md-6 col-md-offset-3">
                    <b>Update Class Counsellor by HOD</b>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <asp:Button ID="submit" runat="server" Text="Update Class Counsellor" CssClass="btn btn-info pull-right" OnClick="submit_Click" />
                        </div>
                    </div>
