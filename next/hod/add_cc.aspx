<%@ Page Title="" Language="C#" MasterPageFile="~/next/hod/hod.master" AutoEventWireup="true" CodeFile="add_cc.aspx.cs" Inherits="next_hod_Default" %>
            ...
            <form role="form">
                <div class="col-md-6 col-md-offset-3">
                   ...
                   <%-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <asp:Button ID="submit" runat="server" Text="Add Class Counsellor" CssClass="btn btn-info pull-right" OnClick="submit_Click" />
                        </div>
                    </div>
            </form>
